...
namespace openpiv::core {
    ...
    using image_view_gf32   = image_view< g_f32 >;
    using image_view_gf64   = image_view< g_f64 >;
    using image_view_gf     = image_view< g_f >;
    using image_view_rgba8  = image_view< rgba_8 >;
    using image_view_rgba16 = image_view< rgba_16 >;
    using image_view_cf32   = image_view< c_f32 >;
    using image_view_cf64   = image_view< c_f64 >;
    using image_view_cf     = image_view< c_f >;
